package Bab2ConstructordanInstanceMethod.TugasPraktikum;
...
class Perpus {
    ...
    public Perpus copy() {
        Perpus perpusCopy = new Perpus(this.kategori, this.penulisbanyak, this.judul, this.bahasa, this.penerbitan, this.edisi, this.halaman, this.sinopsis);
        return perpusCopy;
    }
...
public class javaPerpus {
    public static void main(String[] args) {
        ...
        System.out.println(b16.persentaseKesamaan(b15));
